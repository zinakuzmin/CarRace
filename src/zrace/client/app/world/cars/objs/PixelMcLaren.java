...
/**
 * The Class PixelMcLaren.
 */
public class PixelMcLaren extends Car{
	
	/** The uid. */
	public static int uid = 2007;
    
	/**
	 * Instantiates a new pixel mc laren.
	 */
	public PixelMcLaren() {
	...
	public Xform loadCar() {
        ...
        Box body = Pixel.getPixelBox(Color.DARKTURQUOISE, 10, 5, 20);
        ...
        Color rgbOfUpperBodyAndGant = Color.GOLD;
