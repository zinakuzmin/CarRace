...
/**
 * The Class PixelMrcedesCLKGTR.
 */
public class PixelMrcedesCLKGTR extends Car{
	
	/** The uid. */
	public static int uid = 2008;
    
	/**
	 * Instantiates a new pixel mrcedes CLKGTR.
	 */
	...
	public Xform loadCar() {
        ...
        Box body = Pixel.getPixelBox(Color.FUCHSIA, 10, 5, 20);
