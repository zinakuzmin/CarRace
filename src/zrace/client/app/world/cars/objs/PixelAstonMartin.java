...
/**
 * The Class PixelAstonMartin.
 */
public class PixelAstonMartin extends Car{
	
	/** The uid. */
	public static int uid = 2002;
    
	/**
	 * Instantiates a new pixel aston martin.
	 */
	...
	public Xform loadCar() {
        ...
        Box body = Pixel.getPixelBox(Color.BURLYWOOD, 10, 5, 20);
        ...
        Color rgbOfUpperBodyAndGant = Color.CORNFLOWERBLUE;
