...
/**
 * The Class PixelAudiTT.
 */
public class PixelAudiTT extends Car{
	
	/** The uid. */
	public static int uid = 2003;
    
	/**
	 * Instantiates a new pixel audi TT.
	 */
	public PixelAudiTT() {
	...
	public Xform loadCar() {
        ...
        Box body = Pixel.getPixelBox(Color.DARKSLATEBLUE, 10, 5, 20);
        ...
        Color rgbOfUpperBodyAndGant = Color.SNOW;
        ...
        Color rgbOfSpoiler = Color.DARKGREY;
